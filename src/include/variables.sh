...
INST_MATE=0			# good desktop environment
INST_XFCE=0			# Another good desktop environment
INST_CINNAMON=0		# nice desktop environment
INST_KDE=0     		# even nicer desktop environment
...
INST_SDDM=0 		# the default login manager for KDE_Plasma
...
INST_Firefox=0		# Mozilla browser
INST_Chromium=0		# google browser
INST_Thunderbird=0	# Mozilla mail client
INST_Office=0		# libreoffice
INST_VLC=0			# media player
